...
public class StoreRule implements Rule {
    ...
    public StoreRule(ExecutorService executor, long timeout, TimeUnit timeUnit) {
                ...
                while (true) {
                    ...
                    if (inValue1 != null) {
                        ...
                        try {
                            ...
                            String message = String.format("Function 'IdemFunction' timed out after %d %s", timeout, timeUnit);
                            System.err.println(message);
                            future.cancel(true);
                        }
                        catch (Exception exception) {
                            String message = String.format("Function 'IdemFunction' evaluation error: %s", exception.getMessage());
                            System.err.println(message);
                        }
                    }
