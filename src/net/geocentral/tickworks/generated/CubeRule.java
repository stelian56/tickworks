...
public class CubeRule implements Rule {
    ...
    public CubeRule(ExecutorService executor, long timeout, TimeUnit timeUnit) {
                ...
                while (true) {
                    ...
                    if (inValue1 != null) {
                        ...
                        try {
                            ...
                            String message = String.format("Function 'CubeFunction' timed out after %d %s", timeout, timeUnit);
                            System.err.println(message);
                            future.cancel(true);
                        }
                        catch (Exception exception) {
                            String message = String.format("Function 'CubeFunction' evaluation error: %s", exception.getMessage());
                            System.err.println(message);
                        }
                    }
