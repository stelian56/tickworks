...
public class CountRule implements Rule {
    ...
    private CacheOutputPoint<java.lang.Integer, java.lang.Integer> inputPoint2;
    private net.geocentral.tickworks.Function1<java.lang.Integer, java.lang.Integer> queryFunction2;
    ...
    public CountRule(ExecutorService executor, long timeout, TimeUnit timeUnit) {
    ...
    public void setInputPoint2(CacheOutputPoint<java.lang.Integer, java.lang.Integer> inputPoint2) {
    ...
    public void setQueryFunction2(net.geocentral.tickworks.Function1<java.lang.Integer, java.lang.Integer> queryFunction2) {
        ...
        Runnable runner = new Runnable() {
            public void run() {
                while (true) {
                    ...
                    if (inValue1 != null) {
                        java.lang.Integer query2 = null;
                        Future<java.lang.Integer> future2 = executor.submit(new Callable<java.lang.Integer>() {
                        ...
                        try {
                            ...
                            String message = String.format("Query function 'IdemQueryFunction' timed out after %d %s", timeout, timeUnit);
                            System.err.println(message);
                            future2.cancel(true);
                        }
                        catch (Exception exception) {
                            String message = String.format("Query function 'IdemQueryFunction' evaluation error: %s", exception.getMessage());
                            System.err.println(message);
                        }
                        if (query2 != null) {
